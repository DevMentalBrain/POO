...
namespace sistema_bibliotecario.Classes
{
    internal class LivroAlugado : Livro
    {
        ...
        public LivroAlugado(string titulo, double valorMulta, int qtdExemplaresTotal, int qtdExemplaresDisponiveis, string tipoLivro, DateTime dataAluguel, DateTime prazoDevolução) 
